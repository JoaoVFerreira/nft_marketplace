	...
	return (
		<>
			<main>
						...
						<div className="-mx-4 flex flex-wrap items-center space-y-6 lg:space-y-0">
							...
							<div className="mx-auto px-4 w-full lg:w-6/12">
								...
								<div className="flex flex-wrap gap-4 items-center">
									...
									<a
										href="#"
										className="bg-gradient-to-t bg-gray-800 font-bold from-gray-800 hover:bg-gray-900 hover:from-gray-900 hover:to-gray-800 inline-block px-12 py-2 rounded text-white to-gray-700"
									>
										Explore
									</a>
									<a
					...
					<div className="container mx-auto px-4">
						<div className="-mx-4 flex flex-wrap gap-2 items-center mb-6">
							<div className="px-4 w-full md:flex-1">
								<h2 className="font-bold text-3xl text-gray-900">
									...
									<span>Creators of the Month</span>
								</h2>
							</div>
							<div className="px-4 w-full md:w-auto">
								{" "}
						...
						<div className="-mx-3 flex flex-wrap gap-y-6 justify-center mb-12">
							<div className="px-3 w-full md:w-6/12">
								...
								>
									<img
										src="https://images.unsplash.com/photo-1628359355624-855775b5c9c4?ixid=MnwyMDkyMnwwfDF8c2VhcmNofDE0fHxhcnRpc3R8ZW58MHx8fHwxNjM4OTQzNDMx&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=750&h=450&fit=crop"
										className="group-hover:opacity-90 w-full"
										alt="..."
										width="750"
										height="450"
									/>
									<div className="absolute bg-gray-900 bg-opacity-75 bottom-0 flex group-hover:bg-opacity-60 inset-x-0 items-center justify-between p-4 text-white sm:px-6">
										<h3 className="font-bold">Automex</h3>
										<span className="italic opacity-75">$100,000+</span>
									</div>
								</a>
							</div>
							<div className="px-3 w-full md:w-6/12">
								...
								>
									<img
										src="https://images.unsplash.com/photo-1572266042716-8d696acf2f6f?ixid=MnwyMDkyMnwwfDF8c2VhcmNofDMyM3x8c3V2fGVufDB8fHx8MTYzMTY4Njc4Nw&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=750&h=450&fit=crop"
										className="group-hover:opacity-90 w-full"
										alt="..."
										width="750"
										height="450"
						...
						<div className="-mx-3 flex flex-wrap gap-y-6 justify-center mb-12">
							<div className="px-3 w-full sm:w-6/12">
								...
								<div className="-mx-3 flex flex-wrap gap-y-2">
									<div className="px-3 w-full xl:w-6/12">
										{" "}
										<a
											className="gap-4 group inline-flex items-center text-gray-900"
											href="#"
										>
											{" "}
											<img
												...
												className="border border-4 border-primary-500 group-hover:border-primary-700 rounded-lg"
												height="64"
												alt="Author image"
												width="64"
											/>{" "}
											<div>
												...
												<p className="mb-0 opacity-50 text-black-50">
													$ 100,000+
												</p>
											</div>
										</a>
				...
				<section className="bg-gray-800 py-16 text-center text-gray-400 sm:px-4">
					<div className="container mx-auto px-4 relative">
						<div className="mx-auto w-full lg:w-8/12 xl:w-6/12">
							<h2 className="capitalize font-bold mb-4 text-3xl text-white">
								Explore &bull; Create &bull; Trade
							</h2>
				...
				<div className="container mx-auto pt-12 px-4 relative">
						...
						<div className="px-4 w-full lg:w-6/12 xl:w-5/12">
							...
							<form>
								<div className="bg-white border border-gray-300 flex overflow-hidden p-1 rounded-full">
									...
									<button
										type="submit"
										className="bg-gradient-to-t bg-primary-500 from-primary-500 hover:bg-primary-600 hover:from-primary-600 hover:to-primary-500 inline-block px-6 py-2 rounded-full text-white to-primary-400"
									>
										Sign Up
									</button>
								</div>
					...
					<div className="flex flex-wrap -mx-4">
						...
						<div className="p-4 w-full lg:w-4/12">
							...
							<div className="-mx-2 flex flex-wrap gap-y-4 items-center">
								<div className="px-2 w-1/2 sm:w-4/12">
									<a
										href=""
										className="block hover:opacity-75 overflow-hidden rounded-xl"
									>
										<img
											src="https://images.unsplash.com/photo-1635321856129-af8531379f4b?ixid=MnwyMDkyMnwwfDF8c2VhcmNofDEyOHx8M2QlMjBjaGFyYWN0ZXIlMjByZW5kZXJ8ZW58MHx8fHwxNjM4OTk4MDc0&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=300&h=250&fit=crop"
											width="300"
											height="250"
											className="w-full"
											alt="..."
								...
								<div className="px-2 w-1/2 sm:w-4/12">
									...
									>
										<img
											src="https://images.unsplash.com/photo-1633520409170-2cf3f0b15c9d?ixid=MnwyMDkyMnwwfDF8c2VhcmNofDEwMzB8fDNkJTIwY2hhcmFjdGVyJTIwcmVuZGVyfGVufDB8fHx8MTYzODk5ODM4MQ&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=300&h=250&fit=crop"
											width="300"
											height="250"
											className="w-full"
											alt="..."
								...
								<div className="px-2 w-1/2 sm:w-4/12">
									...
									>
										<img
											src="https://images.unsplash.com/photo-1635321856214-b0ad8fb2ff45?ixid=MnwyMDkyMnwwfDF8c2VhcmNofDk0fHwzZCUyMGNoYXJhY3RlciUyMHJlbmRlcnxlbnwwfHx8fDE2Mzg5OTgwNTU&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=300&h=250&fit=crop"
											width="300"
											height="250"
											className="w-full"
											alt="..."
								...
								<div className="px-2 w-1/2 sm:w-4/12">
									...
									>
										<img
											src="https://images.unsplash.com/photo-1633287453185-6c497fd6f099?ixid=MnwyMDkyMnwwfDF8c2VhcmNofDk4fHxkaWdpdGFsJTIwYXJ0fGVufDB8fHx8MTYzODk5NzkxOA&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=300&h=250&fit=crop"
											width="300"
											height="250"
											className="w-full"
											alt="..."
								...
								<div className="px-2 w-1/2 sm:w-4/12">
									...
									>
										<img
											src="https://images.unsplash.com/photo-1634832413517-7f48f67e3da4?ixid=MnwyMDkyMnwwfDF8c2VhcmNofDE5MHx8M2QlMjBjaGFyYWN0ZXIlMjByZW5kZXJ8ZW58MHx8fHwxNjM4OTk4MDkw&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=300&h=250&fit=crop"
											width="300"
											height="250"
											className="w-full"
											alt="..."
								...
								<div className="px-2 w-1/2 sm:w-4/12">
									...
									>
										<img
											src="https://images.unsplash.com/photo-1634129003118-37a254f894bd?ixid=MnwyMDkyMnwwfDF8c2VhcmNofDYwMXx8M2QlMjBjaGFyYWN0ZXIlMjByZW5kZXJ8ZW58MHx8fHwxNjM4OTk4MjIx&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=300&h=250&fit=crop"
											width="300"
											height="250"
											className="w-full"
											alt="..."
